...
const TR = {
  en: {
    ...
    home: {
      ...
      lead:'We research and develop AI systems spanning game & interactive media, olfactory generation, digital content standards, and trustworthy AI evaluation.',
  ...
  ko: {
    ...
    home: {
      ...
      lead:'게임 & 인터랙티브 미디어, 후각 생성, 디지털 콘텐츠 표준, AI 신뢰성 평가를 아우르는 AI 시스템을 연구하고 개발합니다.',
